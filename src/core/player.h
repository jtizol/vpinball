...
private:
   ...
   // Same, for a BUS master (SoundVolume / MusicVolume). Live only; never persisted.
   static void OnSetAudioBusVolume(const unsigned int msgId, void *userData, void *msgData);
   ...
   unsigned int m_setAudioBusVolMsgId = 0;
